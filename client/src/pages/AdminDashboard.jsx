    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center space-x-2 shrink-0">
          <Link
            to="/admin/import"
            className="inline-flex items-center space-x-1.5 px-4 py-2 bg-navy text-white text-xs font-semibold rounded-lg shadow-sm hover:bg-navy-600 transition-colors"
          >
