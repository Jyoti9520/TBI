                    ...
                    <tr key={u.id} className="hover:bg-slate-50/70 transition-colors">
                      <td className="py-3.5 px-4 font-bold text-slate">
                        <div className="flex items-center space-x-2">
                          <div className="w-7 h-7 rounded-full bg-navy-50 text-navy font-bold flex items-center justify-center text-xs">
                            {u.name ? u.name[0].toUpperCase() : 'U'}
                          </div>
                          <span>{u.name}</span>
                          {isSelf && (
                            <span className="text-[10px] text-teal font-bold bg-teal-50 px-1.5 py-0.5 rounded">
                              You
                            </span>
                          )}
                        </div>
