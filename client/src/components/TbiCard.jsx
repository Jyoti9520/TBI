  ...
  return (
    <div className="bg-surface border border-slate-border rounded-xl p-5 shadow-subtle hover:shadow-card hover:-translate-y-1 hover:border-[#90323D]/50 transition-all duration-200 ease-out flex flex-col justify-between group relative">
      ...
      <div>
        ...
        <div>
          ...
          <p className="text-xs font-semibold text-[#90323D] mt-1.5 flex items-center space-x-1.5 leading-snug">
            <Building2 className="w-3.5 h-3.5 text-[#90323D] shrink-0 transition-transform duration-200 group-hover:scale-105" />
        ...
        <div className="mt-4 space-y-1.5 text-xs text-slate-600">
          ...
          <div className="flex items-center space-x-2">
            <MapPin className="w-3.5 h-3.5 text-[#90323D] shrink-0 transition-transform duration-200 group-hover:scale-105" />
            <span className="truncate">{city}</span>
          </div>

          {/* Official Email with Mail icon */}
          <div className="flex items-center space-x-2">
            <Mail className="w-3.5 h-3.5 text-[#BC8034] shrink-0 transition-transform duration-200 group-hover:scale-105" />
            {email ? (
              <a
                href={`mailto:${email}`}
      ...
      <div className="mt-5 pt-3.5 border-t border-slate-100 flex items-center justify-between">
        ...
        <div>
          {isVerified ? (
            <span className="inline-flex items-center space-x-1 text-xs font-semibold text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded-md border border-emerald-200/60">
              <CheckCircle2 className="w-3.5 h-3.5 text-emerald-600" />
              <span>Verified</span>
            </span>
          ) : isUnderVerification ? (
            <span className="inline-flex items-center space-x-1 text-xs font-semibold text-amber-800 bg-amber-50 px-2 py-0.5 rounded-md border border-amber-200/60">
