    ...
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl sm:text-3xl font-extrabold text-navy flex items-center space-x-2">
          <Bookmark className="w-7 h-7 text-teal" />
      ...
      {loading ? (
        ...
        <div className="text-center py-16 px-4 bg-surface border border-dashed border-slate-border rounded-2xl max-w-md mx-auto my-8">
          ...
          <Link
            to="/explore"
            className="inline-flex items-center space-x-2 px-4 py-2 bg-navy text-white text-xs font-semibold rounded-lg shadow-sm hover:bg-navy-600 transition-colors"
          >
