    ...
    <div className="max-w-3xl mx-auto space-y-6">
      <div>
        <h1 className="text-2xl sm:text-3xl font-extrabold text-[#5E0B15] flex items-center space-x-2">
          <FileSpreadsheet className="w-7 h-7 text-[#90323D]" />
        ...
        <form onSubmit={handleImport} className="space-y-6">
          <div className="border-2 border-dashed border-slate-border hover:border-teal rounded-2xl p-8 text-center bg-slate-50/50 transition-colors">
            ...
            <label
              ...
              className="mt-4 inline-block px-4 py-2 bg-white border border-slate-border rounded-xl text-xs font-semibold text-[#5E0B15] hover:bg-[#D9CAB3]/30 cursor-pointer shadow-subtle transition-colors"
            >
              Browse Files
            </label>
          </div>
          ...
          <button
            ...
            className="w-full py-3 bg-[#5E0B15] hover:bg-[#90323D] disabled:opacity-50 text-[#D9CAB3] font-semibold text-sm rounded-xl shadow-sm transition-colors border border-[#5E0B15]"
          >
      ...
      {report && (
        <div className="bg-surface border border-slate-border rounded-2xl p-6 sm:p-8 shadow-card space-y-4 animate-in fade-in">
          <div className="flex items-center space-x-2 border-b border-slate-border pb-3">
            ...
            <h3 className="text-base font-bold text-[#5E0B15]">Import Report Summary</h3>
          </div>

          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 text-center">
            <div className="p-3 bg-slate-50 rounded-xl">
              <p className="text-xs font-semibold text-slate-muted">Total Rows</p>
              <p className="text-xl font-extrabold text-[#5E0B15] mt-1">{report.totalRows}</p>
            </div>
            ...
            <div className="p-3 bg-[#D9CAB3]/40 rounded-xl border border-[#8C7A6B]">
              <p className="text-xs font-semibold text-[#90323D]">Inserted</p>
              <p className="text-xl font-extrabold text-[#90323D] mt-1">{report.inserted}</p>
            </div>
