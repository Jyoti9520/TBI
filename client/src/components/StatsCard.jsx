...
export const StatsCard = ({ title, value, icon: Icon, color = 'navy', subtitle }) => {
  const colorMap = {
    ...
    amber: 'bg-[#BC8034] text-white border-[#BC8034]',
    green: 'bg-[#D9CAB3]/70 text-[#2E6F40] border-[#8C7A6B]'
  };

  return (
    <div className="bg-surface border border-slate-border rounded-xl p-5 shadow-card hover:shadow-hover hover:border-[#90323D] transition-all flex items-center justify-between">
      <div>
